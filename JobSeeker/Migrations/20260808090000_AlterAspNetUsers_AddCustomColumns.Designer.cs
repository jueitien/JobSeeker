...
namespace JobSeeker.Migrations
{
    ...
    [Migration("20260808090000_AlterAspNetUsers_AddCustomColumns")]
    partial class AlterAspNetUsers_AddCustomColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobSeeker.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("AccountStatus").IsRequired().HasMaxLength(30).HasColumnType("nvarchar(30)");
                    ...
                    b.Property<string>("ProfileImageS3Key").HasMaxLength(1024).HasColumnType("nvarchar(1024)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                { b.HasOne("JobSeeker.Models.ApplicationUser", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired(); });
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserLogin<string>", b =>
                { b.HasOne("JobSeeker.Models.ApplicationUser", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired(); });
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
